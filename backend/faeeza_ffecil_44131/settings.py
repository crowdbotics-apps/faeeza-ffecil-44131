"""
Django settings for faeeza_ffecil_44131 project.
...
ROOT_URLCONF = 'faeeza_ffecil_44131.urls'
...
WSGI_APPLICATION = 'faeeza_ffecil_44131.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "faeeza_ffecil_44131 API",
    "DESCRIPTION": "API documentation for faeeza_ffecil_44131 App",
    "VERSION": "v1",
}
